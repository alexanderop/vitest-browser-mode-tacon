...
url: https://alexop.dev/posts/visual-regression-testing-with-vue-and-vitest-browser/
...
Canonical URL and publication date verified against the live article on 2026-09-14. Article body preserved from the existing user-supplied manuscript; MDX markup is retained. The original capture remains unchanged. Historical API examples are not current Vitest 5 guidance.
