---
kind: article
title: Visual Regression Testing — CI and reference updates
url: https://vitest.dev/guide/browser/visual-regression-testing.html
...
The user supplied the Visual Regression Testing guide, with the navigation labeled v5.0.0 and a last-updated label of 11 August 2026. The canonical Markdown below was fetched on 12 September 2026. This newer guide supplements the existing pinned 4.1.11 documentation; it does not change the talk's dependency versions. Site navigation and advertisements are omitted by the Markdown endpoint.
